//
// Created by warchang on 14.04.2022.
//
...
int creat_socket(int port, int password)
{
    // 1. Get a listening socket
    int listen_sock = startup(port);//Port numbers are passed in as strings and need to be converted to integers
    ...
    server_loop(fd_list[], fd_list_size, listen_sock )
}

void server_loop(struct pollfd fd_list[], int fd_list_size, int listen_sock)
{
    while (1)
    {
